 ...
 */
export function routeConfiguringFunction(driver: import('@appium/types').Core): import('../express/server').RouteConfiguringFunction;
...
export function determineProtocol(createSessionArgs: any): string;
