...
import { removeLineNumbers, isCucumberFeatureWithLineNumber, validObjectOrArray, loadAutoCompilers } from '../utils.js';
...
export default class ConfigParser {
    constructor(_pathService = new FileSystemPathService(), _moduleRequireService = new RequireLibrary()) {
    ...
    async addConfigFile(filename) {
        ...
        try {
            const config = (await this._pathService.loadFile(filePath)).config;
             ...
             */
            const fileConfig = merge(config, {}, MERGE_OPTIONS);
            /**
             * merge capabilities
             */
     ...
     */
    static getFilePaths(patterns, omitWarnings, findAndGlob = new FileSystemPathService(), hierarchyDepth) {
        let files = [];
        let groupedFiles = [];
