...
export async function loadAutoCompilers(autoCompileConfig, requireService) {
    return (autoCompileConfig.autoCompile &&
        (await loadTypeScriptCompiler(autoCompileConfig.tsNodeOpts, autoCompileConfig.tsConfigPathsOpts, requireService)
            ||
                await loadBabelCompiler(autoCompileConfig.babelOpts, requireService)));
}
export function validateTsConfigPaths(tsNodeOpts = {}) {
    /**
...
export async function loadTypeScriptCompiler(tsNodeOpts = {}, tsConfigPathsOpts, requireService) {
    /**
    ...
    try {
        ...
        (await requireService.import('ts-node')).register({ ...tsNodeOpts, esm: 1 });
        ...
        if (tsConfigPathsOpts) {
            ...
            const tsConfigPaths = await requireService.import('tsconfig-paths');
