...
export interface HookFunctions {
     ...
     */
    onWorkerEnd?(cid: string, exitCode: number, specs: string[], retries: number): void;
    /**
     ...
     */
    onComplete?(exitCode: number, config: Omit<TestrunnerOptions, 'capabilities'>, capabilities: RemoteCapabilities, results: any): void;
    /**
     ...
     */
    beforeSession?(config: Omit<TestrunnerOptions, 'capabilities'>, capabilities: RemoteCapability, specs: string[], cid: string): void;
    /**
